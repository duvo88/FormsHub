...
function LawSocietyMediationProgramForm() {
    ...
    useEffect(() => {
        apiService.getSimpleFee('mediation-program').then(amt => setSimpleFee(amt)).catch(() => {});
    }, []);
    ...
    const handleBlur = (fieldName: string, value: string) => {
        ...
        } else if (fieldName === 'emailAddress' && !value.trim()) {
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        const formType = FORM_TYPES.LAW_SOCIETY_MEDIATION_PROGRAM;
        const formTypeShort = FORM_TYPES_SHORT.LAW_SOCIETY_MEDIATION_PROGRAM;
        ...
        try {
            ...
            const formName = FORM_NAMES.LAW_SOCIETY_MEDIATION_PROGRAM;
            ...
            const lineItems = [
                {
                    name: 'Law Society Mediation Program',
        ...
        <div className="App page-root">
            <main className="form-container">
                <section className="form-card" style={{
                    ...
                    <ProgramInfo
                        title="Law Society Mediation Program"
                        description={null}
                        fees={[
...
export default LawSocietyMediationProgramForm;
