...
function PresidentialApptOrNominationSplitFeeForm() {
    ...
    useEffect(() => {
        apiService.getSimpleFee('presidential-split-fee').then(amt => setSimpleFee(amt)).catch(() => {});
    }, []);
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        const formType = FORM_TYPES.PRESIDENTIAL_APPT_OR_NOMINATION_SPLIT_FEE;
        const formTypeShort = FORM_TYPES_SHORT.PRESIDENTIAL_APPT_OR_NOMINATION_SPLIT_FEE;
        ...
        try {
            ...
            const formName = FORM_NAMES.PRESIDENTIAL_APPT_OR_NOMINATION_SPLIT_FEE;
            const price = simpleFee ?? 330;
        ...
        <div className="App page-root">
            <main className="form-container">
                <section className="form-card" style={{
                    ...
                    <ProgramInfo
                        title="Presidential Appointment or Nomination (Split Fee)"
                        description={(
                            <>
                                ...
                                <p>The Law Society of New South Wales charges a non-refundable administration fee of $330.00 (including GST) per party.</p>
                    ...
                    <ApplicantDetails
                        variant="presidential-split-fee"
                        formData={formData}
                        errors={errors}
                        onChange={handleChange}
                        onBlur={handleBlur}
...
export default PresidentialApptOrNominationSplitFeeForm;